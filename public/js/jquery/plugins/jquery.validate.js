...
$.extend($.validator, {
	...
	messages: {
		...
		remote: "Por favor corrgia esse campo.",
	...
	prototype: {
		...
		showLabel: function(element, message) {
			...
			if ( label.length ) {
				...
				label.removeClass().addClass( this.settings.errorClass ).addClass( this.settings.errorLabelClass );
	...
	methods: {
        ...
        hour: function(value, element) {
            return this.optional(element) || /(([0-9]{2})):(([0-9]){2})/.test(value);
        },

        cpf: function(value, element) {
            return this.optional(element) || checaCPF(value);
        },

        cnpj: function(value, element) {
            return this.optional(element) || checaCNPJ(value);
        }
