(function($, undefined){
  ...
  $.widget("ui.datetime", {
    ...
    _chain: function(){
      var o = $.extend({}, this.options, { chainTo: null, chainFrom: this.element, altField: null, minDate: this.options.value }),
          e = (this.options.chainTo) ? (this.options.chainTo == 'self') ? this.element : $(this.options.chainTo) : null;
      if(e && e.is(this.element)){ this.options.chainTo = $('<div>').appendTo(this.container); o.inline = true; }
      ...
      if(this.chainedFrom) this.container.addClass('ui-datetime-to');
    },
    ...
    show: function(){
      ...
      if((!this.inline && !this.ready) || (this.chainedFrom && !this.ready)) this._clock();
    ...
    destroy: function() {
      ...
      if(this.chainedTo && arguments[0]['unchain'] !== false) this.chainedTo.datetime('destroy');
      if(this.chainedFrom && arguments[0]['unchain'] !== false) this.chainedFrom.datetime('destroy');
