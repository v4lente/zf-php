...
//		vUrl="'"+node.url+"'";
		vUrl= node.url;
//		str += '<a id="s' + this.obj + nodeId + '" class="' + ((this.config.useSelection) ? ((node._is ? 'nodeSel' : 'node')) : 'node') + '" style="cursor:hand;" onclick="window.open(' + vUrl + ','+vPop+','+vParam+');"';
		str += '<a id="s' + this.obj + nodeId + '" class="' + ((this.config.useSelection) ? ((node._is ? 'nodeSel' : 'node')) : 'node') + '" style="cursor:hand;" href="' + vUrl + '" target="direita" ';		
