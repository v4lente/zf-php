...
class Marca_PdfMcTable extends FPDF {
    ...
    function Header() {
        ...
        //Logo
        //coloca o logo no cabecalho (função da classe principal)
        //Parametros
        ...
        //Formato da imagem. Os possíveis valores são (diferenciando maiúsculas e minúsculas): JPG, JPEG, PNG. Se não informado, o tipo será inferido pela extensão do arquivo. 
        //URL ou identificador retornado pela função AddLink(). 
        ...
        //Move to the right
        //a funcao FLOOR e uma funcao do php que etorna o próximo menor valor inteiro ao se arredondar para baixo o valor
        //ex: 4.55 = 4 ou 4.99 = 4
        ...
        $this->Cell($this->wTextoCab, 5, $PARAM[0]['no_rel'] . '  (Relatório '.$PARAM[0]['cd_rel'] . ')', 0, 2, 'C');
        //$this->Cell($this->wTextoCab,5,'(Relatório '.$GLOBALS['cd_rel'].')',0,2,'C');
        //Line break
        $this->Ln(10);
    ...
    //////////////////////////////////////////
    // Função para gerar HR (linha horizontal)
    //////////////////////////////////////////
    function HR($a = 0, $d = 0) {
        if($a != 0){
            $this->Ln($a);
    ...
    //////////////////////////////////////////
    // Função para gerar os totais e subtotais
    //////////////////////////////////////////
    ...
    //////////////////////////////////////////
    // Função para processar as quebras de páginas
    //////////////////////////////////////////
    ...
    function formataDados($fmt,$valor){
        //echo 'Valor: '.$valor.'                  >> Formatação: '.$fmt.'<br>';
        switch($fmt){
            case '1':
                return $valor;
            break;
